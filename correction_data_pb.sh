...
minimap2 -x map-pb -t 30 $1 $3 --MD -a --secondary=no -o truth2draft.bam 
...
minimap2 -x map-pb -t 30 $1 $2 --MD -a --secondary=no -o subreads2draft.bam 
...
cat corrected_covered.fasta uncover.fasta > corrected_seq_num.fasta

python seq_num.py --input-file ./corrected_seq_num.fasta --output-file ./corrected.fasta


# evaluate the results

sh evaluate.sh $3 corrected.fasta pb
